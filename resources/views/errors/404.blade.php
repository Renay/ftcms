...
<div class="wrapper-page">
    <div class="ex-page-content text-center">
        <div class="text-error" style="">
            <span style="color:#4285f4;">404</span>
        </div>
        <h2 class="text-white">Ошибка!</h2><br>
        <p style="color: #98a6ad;">Произошла ошибка.. Страница по данному адресу не найдена, сообщите об этом администратору или <a href="//mcperfects.com"  target="_blank" >разработчику</a></p>
        <br>
        <a class="btn btn-success waves-effect waves-light" href="{{$_SERVER['HTTP_REFERER'] ?: '/'}}"> Назад</a>
    </div>
</div>
</body>
</html>