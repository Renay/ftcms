...
@push('scripts')
    <script type="text/javascript">
        $('#weekStatic').highcharts({
            xAxis: {
                categories: {!! json_encode(array_keys($lineChart)) !!},
            },
            yAxis: {
                title: {
                    text: ''
            ...
            series: [{
                color: '#5BBD72',
                type: 'spline',
                data: {!! json_encode(array_values($lineChart), JSON_NUMERIC_CHECK) !!}
            }]
        });
        ...
        $("#pieChart").highcharts({
            ...
            series: [{
                ...
                data: {!! json_encode($pieChart, JSON_NUMERIC_CHECK) !!}
            }]
        });
    </script>
@endpush