    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <div class="text-center">
                <a href="javascript:void(0)" class="logo"><i class="icon-magnet icon-c-logo"></i>
        ...
        <nav class="navbar-custom">
            <ul class="list-inline float-right mb-0">
                ...
                <li class="list-inline-item dropdown notification-list">
                    <a class="nav-link dropdown-toggle arrow-none waves-light waves-effect" data-toggle="dropdown" href="javascript:void(0)" role="button"
            ...
            <ul class="list-inline menu-left mb-0">
                <li class="float-left hidden-lg-up">
