    <form class="form-horizontal" method="POST" action="/admin/merchant/unitpay">
        <div class="form-group">
            ...
            <div class="col-sm-12">
                <input type="text" name="merchant[publicKey]" class="form-control1" value="{{ $publicKey }}" id="shop_id" placeholder="Введите id магазина">
            </div>
        </div>
        <div class="form-group">
            <label for="secretKey" class="col-sm-8">Секретный ключ</label>
            <div class="col-sm-12">
                <input type="text" name="merchant[secretKey]" class="form-control1" value="{{ $secretKey }}" id="secretKey" placeholder="Введите секретный ключ">
            </div>
        </div>
