    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title pull-left">Описание для товара {{$name}}</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="name" value="{{$name}}" hidden title="" />
                                <textarea class="form-control" wrap="soft" name="description" rows="10"
                                          placeholder="Введите описание для данного товара...">{{nr2ds($description, ['<br />'])}}</textarea>
                            </div>
                        </div>
                    </div>
                </form>
