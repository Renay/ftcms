...
<html>
<head>
<title>Login :: <?php echo e(Setting::get('name_site')); ?></title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper" style="margin: 0">
			<div class="main-page login-page">
				<div class="widget-shadow">
					<div class="login-top">
						<h4>Приветствуем в Админ панель проекта <?php echo e(Setting::get('name_site')); ?>!  <br> Вернутся на главную? <a href="/">Жми Сюда »</a> </h4>
					</div>
		...
		<footer class="footer-login">
		   <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(Setting::get('name_site')); ?>. All Rights Reserved | Design by <a href="https://w3layouts.com/" target="_blank">w3layouts</a></p>
		</footer>
        <!--//footer-->
	</div>
	<!-- Classie -->
