        ...
        <div class="row">
            <div class="col-md-12">
                <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                    ...
                    <h3>Привила <a href="https://vk.com/topic-125608997_36859102">DeepMine</a> </h3>
                </div>
                ...
                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-2">
                            <div class="user text-center">
                                <img src="face.php?user=<?php echo e($user->username); ?>" alt="<?php echo e($user->username); ?>">
                                <div class="user-desc">
                                    <p class="name"><?php echo e($user->username); ?></p>
                                    <p class="goods"><b><?php echo e($user->goods); ?></b></p>
                                    <p class="date"><?php echo e(date('d.m \в H:i', strtotime($user->created_at))); ?></p>
                                </div>
                            </div>
                        </div>
